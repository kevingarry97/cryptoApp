        ...
        <div className="bg-[#181918] m-4 flex flex-1 2xl:min-w-[450px] 2xl:max-w-[500px] sm:min-w-[270px] sm:max-w-[300px] flex-col p-3 rounded-mdhover:shadow-2xl">
            <div className="flex flex-col items-center w-full mt-3">
                <div className="w-full mb-6 p-2">
                    <a href={`https://robsten.etherscan.io/address/${addressFrom}`} target="_blank" rel="noopener noreferre">
                        <p className="text-white text-base">From: {shortenAddress(addressFrom)}</p>
                    </a>
                    <a href={`https://robsten.etherscan.io/address/${addressTo}`} target="_blank" rel="noopener noreferre">
        ...
        <div className="flex w-full justify-center items-center 2xl:px-20 gradient-bg-transactions">
            <div className="flex flex-col md:p-12 py-12 px-4">
                {currentAccount ? (
                    ...
                    <h3 className="text-white text-3xl text-center my-2">Connect account to see latest changes</h3>
                )}
